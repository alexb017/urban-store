        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            {product?.color?.map((color) => {
              ...
              const classname =
                'text-sm border rounded-full py-1 px-2 bg-neutral-200 hover:border-blue-500 hover:scale-105 transition-all dark:bg-neutral-900';
              return (
                <button
                  key={color}
                  type="button"
        ...
        <div className="my-6">
          ...
          <div className="flex items-center flex-wrap gap-2">
            {product?.size?.map((size) => {
              ...
              const classname =
                'text-sm uppercase border rounded-full py-1 px-4 bg-neutral-200 hover:border-blue-500 hover:scale-105 transition-all dark:bg-neutral-900';
              return (
                <button
                  key={size}
                  type="button"
